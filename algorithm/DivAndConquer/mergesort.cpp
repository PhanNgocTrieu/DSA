/*
    ...
    until these subproblems become simple enough to be solved directly [1]. 
    Then one combines the results of subproblems to form the final solution.
    
    Steps:
    1. Divide. Divide the problem SS into a set of subproblems: {S1,S2,...Sn}{S1​,S2​,...Sn​} where n≥2n≥2, i.e. \
    there are usually more than one subproblem.
